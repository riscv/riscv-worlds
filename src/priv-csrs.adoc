...
|SRW 
|`slwid`
| Supervisor WID value for lower privilege modes (i.e., U, VS or VU) Register. 
...
|`0x748`
|MRW
|`mwiddeleg` aka `mwiddeleg0`
| Machine WID values delegated to [H]S mode Register.
|
|MRW
|`mwiddeleg1`
| Machine WID values delegated to [H]S mode Register, RV32 only.
|`0x748`
|MRW
|`mwiddeleg2`
| Machine WID values delegated to [H]S mode Register.
